...
export const TOKENS = {
  ...
  SPX:   { address: '0x6f911b6b39bcc665a463129c94b5380a4387b7eb' as `0x${string}`, symbol: 'SPX6900', decimals: 8,  name: 'SPX6900' },
...
export const POOLS = [
  ...
  { name: 'AEON/SPX6900',   token0: 'AEON', token1: 'SPX',   type: 'CL',   fee: '0.3%',  address: '0xabCE7E6160dF0B1E7a300FfA55AC26843A59710b' as `0x${string}` },
  ...
  { name: 'WAVAX/SPX6900',  token0: 'WAVAX',token1: 'SPX',   type: 'CL',   fee: '0.3%',  address: '0x836Aeed458857E5Fd4134c7dAF7B36EE20B73DBc' as `0x${string}` },
  ...
  { name: 'SPX6900/USDC',   token0: 'SPX',  token1: 'USDC',  type: 'CL',   fee: '0.3%',  address: '0xFb0b8D088691057fE08040f4364494c23B60c66C' as `0x${string}` },
  ...
  // DLMM
  { name: 'AEON/WAVAX', token0: 'AEON', token1: 'WAVAX', type: 'DLMM', fee: '1%',    binStep: 800, address: '0xF03A55f9578c35Ec442e2F5dA040C20fF3A59489' as `0x${string}` },
  { name: 'AEON/USDC',  token0: 'AEON', token1: 'USDC',  type: 'DLMM', fee: '1%',    binStep: 800, address: '0xFD029a446632618f218189d4a0B572896CD29B58' as `0x${string}` },
  { name: 'AEON/WBTCE', token0: 'AEON', token1: 'WBTCE', type: 'DLMM', fee: '1%',    binStep: 800, address: '0xecB2EbB887cbbC810BA519906594185d8f1fc704' as `0x${string}` },
  { name: 'AEON/WETHE', token0: 'AEON', token1: 'WETHE', type: 'DLMM', fee: '1%',    binStep: 800, address: '0x954068b2289E2EdFA878f17C27b4ab1B015b77a7' as `0x${string}` },
  { name: 'AEON/SPX6900',   token0: 'AEON', token1: 'SPX',   type: 'DLMM', fee: '1%',    binStep: 800, address: '0x966fdDEBC8311Bb5a22c625129257213D54a6938' as `0x${string}` },
  { name: 'AEON/GUNZ',  token0: 'AEON', token1: 'GUNZ',  type: 'DLMM', fee: '1%',    binStep: 800, address: '0x45C0D4fffbe60fBC454F8dB0Eb2643aa139cb706' as `0x${string}` },
  { name: 'AEON/ARENA', token0: 'AEON', token1: 'ARENA', type: 'DLMM', fee: '1%',    binStep: 800, address: '0x978968E5f40f1b183959Ca8852718e22A6f3fcE7' as `0x${string}` },
  { name: 'AEON/COQ',   token0: 'AEON', token1: 'COQ',   type: 'DLMM', fee: '1%',    binStep: 800, address: '0x1d891FC5954D777ABbb95fadAC8D7dE880b9F49a' as `0x${string}` },
  ...
  { name: 'WAVAX/GUNZ', token0: 'WAVAX',token1: 'GUNZ',  type: 'DLMM', fee: '1%',    binStep: 800, address: '0x1E173e4d5811F27E72300a214DeeF4eFCB3B6be8' as `0x${string}` },
  ...
  { name: 'WAVAX/COQ',  token0: 'WAVAX',token1: 'COQ',   type: 'DLMM', fee: '1%',    binStep: 800, address: '0xddbcC56993a6D44b24Bd9AF0A27000419B0d9B4F' as `0x${string}` },
  { name: 'WAVAX/SPX6900',  token0: 'WAVAX',token1: 'SPX',   type: 'DLMM', fee: '1%',    binStep: 800, address: '0xaA35b2EA1deB790585f9fd11d1878Dc0606091a3' as `0x${string}` },
  ...
  { name: 'SPX6900/USDC',   token0: 'SPX',  token1: 'USDC',  type: 'DLMM', fee: '0.3%',  binStep: 800, address: '0xFb0b8D088691057fE08040f4364494c23B60c66C' as `0x${string}` },
