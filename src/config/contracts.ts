...
export const POOLS = [
  ...
  // CL — token0/token1 verified on-chain
  { name: 'AEON/WAVAX', token0: 'WAVAX', token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0xd1C58E8B2E3d54FbFf443F34c67952c033aC77a6' as `0x${string}` },
  { name: 'AEON/USDC',  token0: 'USDC',  token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0x29c818b0929F9D247157f7b17a49B89664C9efcE' as `0x${string}` },
  { name: 'AEON/WBTCE', token0: 'WBTCE', token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0x6658A37c6F1544129CfBA898F827c64680db00b6' as `0x${string}` },
  { name: 'AEON/WETHE', token0: 'WETHE', token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0xEF43D5718ec0e22e105e21b9292bE33a7daC5061' as `0x${string}` },
  { name: 'AEON/GUNZ',  token0: 'GUNZ',  token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0x98F41ef967fC9105d83E5a1B44512C25ae15E53E' as `0x${string}` },
  { name: 'AEON/ARENA', token0: 'ARENA', token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0x1C95905E0C7D290A46E1d970BeCD315BE10b3421' as `0x${string}` },
  { name: 'AEON/COQ',   token0: 'COQ',   token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0x69174eFdFAE19af3BfbC45e2dbdccfC1A44FdE9b' as `0x${string}` },
  ...
  { name: 'WAVAX/WETHE',token0: 'WETHE', token1: 'WAVAX',type: 'CL',   fee: '0.3%',  address: '0x4fAA1a9B62Be8465f33fB3c3ac767F6bc4e510DB' as `0x${string}` },
  { name: 'WAVAX/WBTCE',token0: 'WBTCE', token1: 'WAVAX',type: 'CL',   fee: '0.3%',  address: '0xE82347882508179DDED4e74BD4645fad0895e0E7' as `0x${string}` },
  { name: 'WAVAX/GUNZ', token0: 'GUNZ',  token1: 'WAVAX',type: 'CL',   fee: '0.3%',  address: '0x29dFab19335Bcc8E05811d5F9d047372A391DB9C' as `0x${string}` },
  ...
  { name: 'WAVAX/COQ',  token0: 'COQ',   token1: 'WAVAX',type: 'CL',   fee: '0.3%',  address: '0x2b97cEC6A8B1D90732E2c5Fe17433E647cDe62Cc' as `0x${string}` },
