...
export const POOLS = [
  ...
  { name: 'AEON/SPX',   token0: 'AEON', token1: 'SPX',   type: 'DLMM', fee: '1%',    binStep: 800, address: '0x966fdDEBC8311Bb5a22c625129257213D54a6938' as `0x${string}` },
  ...
  { name: 'WAVAX/SPX',  token0: 'WAVAX',token1: 'SPX',   type: 'DLMM', fee: '1%',    binStep: 800, address: '0xaA35b2EA1deB790585f9fd11d1878Dc0606091a3' as `0x${string}` },
  ...
  { name: 'SPX/USDC',   token0: 'SPX',  token1: 'USDC',  type: 'DLMM', fee: '0.3%',  binStep: 800, address: '0xFb0b8D088691057fE08040f4364494c23B60c66C' as `0x${string}` },
  { name: 'SPX/WAVAX',  token0: 'SPX',  token1: 'WAVAX', type: 'DLMM', fee: '0.3%',  binStep: 800, address: '0x836Aeed458857E5Fd4134c7dAF7B36EE20B73DBc' as `0x${string}` },
