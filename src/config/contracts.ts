...
export const POOLS = [
  ...
  { name: 'AEON/SPX6900', token0: 'AEON', token1: 'SPX', type: 'CL',   fee: '0.3%',  address: '0x56889e4e8c9c1eaf7a91f436c32a1a9fdfcacb0e' as `0x${string}` },
  { name: 'AEON/SPX6900', token0: 'AEON', token1: 'SPX', type: 'DLMM', fee: '1%',    binStep: 800, address: '0xeac2c4b5b9a1169c7e46a44ed6a5e4836ba3bb95' as `0x${string}` },
]
