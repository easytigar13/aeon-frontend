...
export const POOLS = [
  ...
  // Legacy CL pools (pre-2026-07-01 deploy) — kept ONLY so LPs still staked there can unstake/withdraw. Do not add new liquidity.
  { name: 'AEON/WAVAX (Legacy)', token0: 'WAVAX', token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0xd1C58E8B2E3d54FbFf443F34c67952c033aC77a6' as `0x${string}` },
  { name: 'AEON/USDC (Legacy)',  token0: 'USDC',  token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0x29c818b0929F9D247157f7b17a49B89664C9efcE' as `0x${string}` },
  { name: 'AEON/WBTCE (Legacy)', token0: 'WBTCE', token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0x6658A37c6F1544129CfBA898F827c64680db00b6' as `0x${string}` },
  { name: 'AEON/WETHE (Legacy)', token0: 'WETHE', token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0xEF43D5718ec0e22e105e21b9292bE33a7daC5061' as `0x${string}` },
  { name: 'AEON/GUNZ (Legacy)',  token0: 'GUNZ',  token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0x98F41ef967fC9105d83E5a1B44512C25ae15E53E' as `0x${string}` },
  { name: 'AEON/ARENA (Legacy)', token0: 'ARENA', token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0x1C95905E0C7D290A46E1d970BeCD315BE10b3421' as `0x${string}` },
  { name: 'AEON/COQ (Legacy)',   token0: 'COQ',   token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0x69174eFdFAE19af3BfbC45e2dbdccfC1A44FdE9b' as `0x${string}` },
  { name: 'WAVAX/USDC (Legacy)', token0: 'WAVAX', token1: 'USDC', type: 'CL',   fee: '0.05%', address: '0x5205f2D5BF9957335eF847E59F799Bc0a801B01b' as `0x${string}` },
  { name: 'WAVAX/WETHE (Legacy)',token0: 'WETHE', token1: 'WAVAX',type: 'CL',   fee: '0.3%',  address: '0x4fAA1a9B62Be8465f33fB3c3ac767F6bc4e510DB' as `0x${string}` },
  { name: 'WAVAX/WBTCE (Legacy)',token0: 'WBTCE', token1: 'WAVAX',type: 'CL',   fee: '0.3%',  address: '0xE82347882508179DDED4e74BD4645fad0895e0E7' as `0x${string}` },
  { name: 'WAVAX/GUNZ (Legacy)', token0: 'GUNZ',  token1: 'WAVAX',type: 'CL',   fee: '0.3%',  address: '0x29dFab19335Bcc8E05811d5F9d047372A391DB9C' as `0x${string}` },
  { name: 'WAVAX/ARENA (Legacy)',token0: 'WAVAX', token1: 'ARENA',type: 'CL',   fee: '0.3%',  address: '0x1EdEE242F3F1Af2B9B330557816459988a75378b' as `0x${string}` },
  { name: 'WAVAX/COQ (Legacy)',  token0: 'COQ',   token1: 'WAVAX',type: 'CL',   fee: '0.3%',  address: '0x2b97cEC6A8B1D90732E2c5Fe17433E647cDe62Cc' as `0x${string}` },
  { name: 'WBTCE/USDC (Legacy)', token0: 'WBTCE', token1: 'USDC', type: 'CL',   fee: '0.3%',  address: '0xC84D3fb669b3b0369978E253dC2F1B7329F6D7eF' as `0x${string}` },
  { name: 'WETHE/USDC (Legacy)', token0: 'WETHE', token1: 'USDC', type: 'CL',   fee: '0.05%', address: '0x306B89922bccea64545e701795Ffbf20FB5a0f70' as `0x${string}` },
  { name: 'GUNZ/USDC (Legacy)',  token0: 'GUNZ',  token1: 'USDC', type: 'CL',   fee: '0.3%',  address: '0x1cf8d65A13D7cA3a793a8E6bb28aA5Ae90ea14Dd' as `0x${string}` },
  { name: 'ARENA/USDC (Legacy)', token0: 'ARENA', token1: 'USDC', type: 'CL',   fee: '0.3%',  address: '0xBf9F67B3dA5F27035DCEff232b0b31F08CfB2a77' as `0x${string}` },
  { name: 'COQ/USDC (Legacy)',   token0: 'COQ',   token1: 'USDC', type: 'CL',   fee: '0.3%',  address: '0x19aE273606588fb17D99572321eAD9b0B060DF00' as `0x${string}` },
  { name: 'USDC/WUSDT (Legacy)', token0: 'WUSDT', token1: 'USDC', type: 'CL',   fee: '0.01%', address: '0xB1a5295A8133097E389221df70Ee1dd021B088F0' as `0x${string}` },
  { name: 'AEON/WBTCB (Legacy)',  token0: 'WBTCB', token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0x04de9ee7b6355ec643db415b2212734390fcb2f8' as `0x${string}` },
  { name: 'WAVAX/WBTCB (Legacy)', token0: 'WBTCB', token1: 'WAVAX',type: 'CL',   fee: '0.3%',  address: '0xeb55b531c1881751d6c83ce343ee3870a3ed6cb3' as `0x${string}` },
  { name: 'AEON/SPX6900 (Legacy)', token0: 'SPX',  token1: 'AEON', type: 'CL',   fee: '0.3%',  address: '0x56889e4e8c9c1eaf7a91f436c32a1a9fdfcacb0e' as `0x${string}` },
